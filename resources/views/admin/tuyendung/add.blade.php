                      ...
                      <div class="col-lg-12">
                        <div class="card">
                          ...
                          <div class="card-body card-block">
                            <form action="quantri/tuyendung/add" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="namecty" placeholder="Text" class="form-control"></div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Mức lương</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="price" placeholder="Text" class="form-control"></div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Yêu cầu kĩ năng</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="skill" placeholder="Text" class="form-control"></div>
                              </div>
                              <div class="row form-group">
                                  <div class="col col-md-3"><label for="text-input" class=" form-control-label">Địa điểm</label></div>
                                  <div class="col-12 col-md-9"><input type="text" id="text-input" name="point" placeholder="Text" class="form-control" ></div>
                                </div>
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="date" name="expired" max="3000-12-31" 
                                  min="1000-01-01" class="form-control"></div>
                              </div>
                              {{-- <div class="row form-group">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                  <textarea name="job" id="text" cols="30" rows="25" class="ckeditor" ></textarea>
